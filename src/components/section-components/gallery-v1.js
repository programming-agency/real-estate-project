				...
				<div className="row ltn__image-slider-4-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
					<div className="col-lg-12">
						<div className="ltn__img-slide-item-4">
							<a href={"/assets/img/img-slide/21.jpg"} data-rel="lightcase:myCollection">
					...
					<div className="col-lg-12">
						<div className="ltn__img-slide-item-4">
							<a href={"/assets/img/img-slide/22.jpg"} data-rel="lightcase:myCollection">
					...
					<div className="col-lg-12">
						<div className="ltn__img-slide-item-4">
							<a href={"/assets/img/img-slide/23.jpg"} data-rel="lightcase:myCollection">
					...
					<div className="col-lg-12">
						<div className="ltn__img-slide-item-4">
							<a href={"/assets/img/img-slide/24.jpg"} data-rel="lightcase:myCollection">
