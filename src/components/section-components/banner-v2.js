								...
								<div className="row">
									<div className="col-lg-12 align-self-center">
										...
										<div className="slide-item-img">
											<img src={"/assets/img/slider/61.jpg"} alt="#" />
										</div>
									</div>
								</div>
							</div>
					...
					<div className="ltn__slider-11-img-slide-arrow-inner">
						<div className="ltn__slider-11-img-slide-arrow-active">
							<div className="image-slide-item">
								<img src={"/assets/img/slider/61.jpg"} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={"/assets/img/slider/62.jpg"} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={"/assets/img/slider/63.jpg"} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={"/assets/img/slider/64.jpg"} alt="Flower Image" />
							</div>
						</div>
