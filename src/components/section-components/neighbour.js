					...
					<div className="col-lg-12">
						<div className="ltn__neighbour-tab-wrap">
							<div className="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
								<div className="nav">
									<a className="active show" data-bs-toggle="tab" href="#liton_tab_4_1"><img src={"/assets/img/neighbour/1.jpg"} alt="#" /></a>
									<a data-bs-toggle="tab" href="#liton_tab_4_2" ><img src={"/assets/img/neighbour/2.jpg"} alt="#" /></a>
									<a data-bs-toggle="tab" href="#liton_tab_4_3" ><img src={"/assets/img/neighbour/3.jpg"} alt="#" /></a>
								</div>
							</div>
